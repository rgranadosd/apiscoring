...
# Desinstalar la versión actual de la extensión en VS Code
code --uninstall-extension InditexTech.vscode-apiscoring || true

# Instalar la nueva versión generada
VSIX_FILE=$(ls -t vscode-apiscoring-*.vsix | head -n1)
code --install-extension "$VSIX_FILE"
echo "Extensión instalada: $VSIX_FILE" 